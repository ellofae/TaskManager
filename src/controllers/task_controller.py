...
class TaskController:
    ...
    def create(self, task: TaskCreationForm, current_user_id: int) -> Task:
        ...
        company_user = self.company_user_service.check_weather_user_exists_wrapper(current_user_id, task.company_id)
    ...
    def get_all_tasks(self, company_id: int, user_id: int) -> list[Task]:
        self.company_user_service.check_weather_user_exists_wrapper(user_id, company_id)
