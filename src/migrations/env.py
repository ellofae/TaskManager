...
config.set_section_option(section, "DATABASE_USER", DATABASE_USER)
config.set_section_option(section, "DATABASE_PASSWORD", DATABASE_PASSWORD)
config.set_section_option(section, "DATABASE_HOST", DATABASE_HOST)
...
from database.database import DatabaseBase
